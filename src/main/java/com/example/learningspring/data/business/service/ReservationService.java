package com.example.learningspring.data.business.service;
...
public class ReservationService {
    ...
    public List<RoomReservation> getRoomReservationsForDate(Date date){
        ...
        Iterable<Reservation> reservations = this.reservationsRepository.findReservationByResDate(new java.sql.Date(date.getTime()));
